...
const NotFound = () => {
  ...
  return (
    <section className="container pt-36 md:pt-0 max-w-6xl font-[family-name:var(--font-geist-sans)] relative min-h-screen md:min-h-[650px] lg:mt-10 p mx-auto px-4 lg:py-4">
      {/* Floating Card */}
      <motion.div
